...
namespace Fishing.Core
{
    ...
    public class FishingController : MonoBehaviour
    {
        ...
        public void PerformCast(Vector3 targetPosition, FishingSpotData spot)
        {
            ...
            {
                Debug.LogWarning("Ñíà÷àëà çàâåðøè òåêóùóþ ðûáàëêó!");
                return;
            }

            if (spot == null)
            {
                Debug.LogError("Äëÿ çàáðîñà íå âûáðàíà FishingSpotData!");
                return;
            }
        ...
        {
            // Çàùèòà îò çàïîçäàâøåé êîðóòèíû ïîñëå îòìåíû.
        ...
        public void OnFishTired()
        {
            ...
            Debug.Log($"Ðûáà {landedFish.fishName} ïîéìàíà!");

            // Ïîñëå ýòîãî ìîæíî îñòàíîâèòü ìèíè-èãðó
            // ... âàø êîä äëÿ ñáðîñà ñîñòîÿíèÿ ìèíè-èãðû ...
            ResetFishingSystems();
        ...
        public void OnFishEscape()
        {
            ...
            Debug.Log("Ðûáàëêà çàâåðøåíà áåç óëîâà.");
        }
